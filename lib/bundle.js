...
class Map {
  ...
  muteOtherPaths(hoveredPath) {
    for(let i = 0; i < this.paths.length; i++) {
      if (this.paths[i] === hoveredPath) { continue }
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _sound_util__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./sound_util */ "./lib/sound_util.js");
...
class PathSegment {
  ...
  playSound() {
    ...
    let oscSound = new _sound_util__WEBPACK_IMPORTED_MODULE_0__["default"](this.audioCtx);
